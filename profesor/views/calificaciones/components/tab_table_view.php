<?php
/**
 * Vista de tabla de calificaciones
...
<form id="form-calificaciones" class="form-calificaciones">
    <input type="hidden" name="asignacion_id" id="asignacion_id" value="<?php echo htmlspecialchars($grado['asignacion_id'] ?? '1'); ?>">
    <?php if ($esMultigrado): ?>
                        ...
                        <?php foreach ($tipos as $tipo): ?>
                            <th class="nota-header <?php echo strtolower($categoria); ?>">
                                <div class="nota-header-content">
                                    ...
                                    <small><?php echo isset($tipo['porcentaje']) ? $tipo['porcentaje'].'%' : '0%'; ?></small>
                                </div>
                            </th>
                        <?php endforeach; ?>
                    <?php endforeach; ?>
                    ...
                    <tr data-student-id="<?php echo $estudiante['id']; ?>">
                        ...
                        <td>
                            <div class="definitiva-cell">
                                <span class="final-grade <?php echo CalificacionesHelperSimple::getColorClase((float)$definitiva); ?>">
                                    <?php echo $definitiva; ?>
                                </span>
                            </div>
                        </td>
...
<!-- Botón flotante para guardar notas -->
<div class="floating-save-button" id="btnFloatingSave">
